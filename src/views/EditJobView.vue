<script setup>
import { ref, onMounted } from 'vue'; // Uvoz ref funkcije
...
onMounted(async () => {
    try {
        const response = await axios.get(`/api/jobs/${jobId}`); //get data
        form.value = response.data;
        console.log(response.data);
        console.log(form.value);
    } catch (error) {
        console.log('sorry erro', error);
    }
});

const handleSubmit = async () => {
    try {
        const response = await axios.put(`/api/jobs/${jobId}`, form.value); //put enc update data
